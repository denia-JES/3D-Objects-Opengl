...
pygame.init()
pygame.display.set_caption("Стаховський Денис")
...
while running:
    ...
    if keys[pygame.K_UP]:
        ...
        rot_x = pyrr.Matrix44.from_x_rotation(-0.8 * ct)
        ...
        rot_y = pyrr.Matrix44.from_y_rotation(90 * ct)
        glUniformMatrix4fv(rotation_loc, 1, GL_FALSE, pyrr.matrix44.multiply(rot_x, rot_y))
    else:
        glUniformMatrix4fv(rotation_loc, 1, GL_FALSE,
                           pyrr.matrix44.multiply(pyrr.Matrix44.from_x_rotation(2), pyrr.Matrix44.from_y_rotation(4)))
